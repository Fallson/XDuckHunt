...
@property (nonatomic, retain)CCLabelTTF* left_time_label;
...
-(id) initWithWinRect: (CGRect)rect
{
	if( (self=[super init]) )
    {
        ...
        self.score_label = [CCLabelTTF labelWithString:score_str fontName:@"sniglet.ttf" fontSize:24];
        ...
        self.left_time_label = [CCLabelTTF labelWithString:left_time_str fontName:@"sniglet.ttf" fontSize:24];
        ...
        self.hit_count_label = [CCLabelTTF labelWithString:hit_count_str fontName:@"sniglet.ttf" fontSize:24];
...
{
    NSString* score_str = [NSString stringWithFormat:@"score: %d", self.score];
    //self.score_label = [CCLabelTTF labelWithString:score_str fontName:@"sniglet" fontSize:24];
    [self.score_label setString:score_str];
    
    NSString* left_time_str = [NSString stringWithFormat:@"left time: %d", (int)self.left_time];
    //self.left_time_label = [CCLabelTTF labelWithString:left_time_str fontName:@"sniglet" fontSize:24];
    [self.left_time_label setString:left_time_str];
    
    NSString* hit_count_str = [NSString stringWithFormat:@"hit count: %d", self.hit_count];
    //self.hit_count_label = [CCLabelTTF labelWithString:hit_count_str fontName:@"sniglet" fontSize:24];
